...
class TestPreviouscourses():
  ...
  def test_previouscourses(self):
    self.login()

    self.driver.get("https://portal.aut.ac.ir/aportal/LoginRole.jsp")
    self.driver.set_window_size(1512, 867)
    self.driver.switch_to.frame(2)
    self.driver.find_element(By.LINK_TEXT, "دروس").click()
    self.driver.switch_to.default_content()
    self.driver.switch_to.frame(1)
    self.driver.switch_to.frame(1)
    self.driver.find_element(By.ID, "webfx-tree-object-4-anchor").click()
    self.driver.switch_to.default_content()
    self.driver.switch_to.frame(0)
    self.driver.find_element(By.CSS_SELECTOR, ".stdbutton").click()
    self.driver.find_element(By.CSS_SELECTOR, ".stdbutton").click()
