...
class TestPersianReport():
  ...
  def test_persian_report(self):
    self.login()

    self.driver.get("https://portal.aut.ac.ir/aportal/LoginRole.jsp")
    self.driver.set_window_size(1512, 867)
    self.driver.switch_to.frame(2)
    self.driver.find_element(By.LINK_TEXT, "ترمي").click()
    self.driver.switch_to.default_content()
    self.driver.switch_to.frame(1)
    self.driver.find_element(By.NAME, "st_semesters_transcript_farsi").click()
    self.driver.switch_to.default_content()
    self.driver.switch_to.frame(2)
    self.driver.find_element(By.LINK_TEXT, "ميز کار").click()
